        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Add Position Data Employee</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    @endif
                <form class="form-horizontal" action="{{route('addPost') }}" method="post">
                    @csrf
                    <div class="card-body">
                      <div class="form-group row">
                        <label for="position_name" class="col-sm-2 col-form-label">Position Name</label> :
                        <div class="col-sm-3">
                          <input type="text" value="{{ old('position_name') }}" name="position_name" class="form-control" id="position_name" placeholder="Position Name">
                        </div>
                      </div>
                      <div class="form-group row">
