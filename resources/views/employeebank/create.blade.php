        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Add Employee Bank Data</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    @endif --}}
                <form class="form-horizontal" action="{{route('AddEmployeebank') }}" method="post">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-3">
                            <select name="bank_id" class="form-control select2 select2-hidden-accessible">
                                ...
                                <option value="{{ $banks->id }}" {{ old('bank_id') == $banks->id ? 'selected' : '' }}>
                                  {{ $banks->bank_name }}
                                </option>
                              @endforeach
                              </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{ old('bank_account_no') }}" name="bank_account_no" class="form-control" id="bank_account_no" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{ old('bank_account_name') }}" name="bank_account_name" class="form-control" id="bank_account_name" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{ old('bank_account_branch') }}" name="bank_account_branch" class="form-control" id="bank_account_branch" placeholder="">
