        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Add Employee Administration</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    @endif --}}
                <form class="form-horizontal" action="{{route('AddAdministration') }}" method="post">
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{ old('nik') }}" name="nik" class="form-control" id="nik" placeholder="">
                              @if ($errors->any('nik'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{ old('class') }}" name="class" class="form-control" id="class" placeholder="">
                              @if ($errors->any('class'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="date" value="{{ old('doh') }}" name="doh" class="form-control" id="doh" placeholder="">
                              @if ($errors->any('doh'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{ old('poh') }}" name="poh" class="form-control" id="poh" placeholder="">
                              @if ($errors->any('poh'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{ old('basic_salary') }}" name="basic_salary" class="form-control" id="basic_salary" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{ old('site_allowance') }}" name="site_allowance" class="form-control" id="site_allowance" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{ old('other_allowance') }}" name="other_allowance" class="form-control" id="other_allowance" placeholder="">
