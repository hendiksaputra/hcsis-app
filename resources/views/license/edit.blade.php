        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Edit Driver License Data Employee</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    @endif
                <form class="form-horizontal" action="/updateLicense/{{$licenses->slug}}" method="post">
                    @method('put')
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="col-sm-3">
                            <select name="employee_id" class="form-control select2 select2-hidden-accessible">
                                ...
                                <option value="{{ $employee->id }}"
                                  {{ old('employee_id', $licenses->employee_id) == $employee->id ? 'selected' : '' }}>
                                  {{ $employee->fullname }}
                                </option>
                                @endforeach
                              </select>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                          <input type="text" name="driver_license_no" class="form-control" id="driver_license_no" value="{{$licenses->driver_license_no}}">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                          <input type="text" value="{{$licenses->driver_license_type}}" name="driver_license_type" class="form-control" id="driver_license_type" placeholder="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                          <input type="date" value="{{$licenses->driver_license_exp}}" name="driver_license_exp" class="form-control" id="driver_license_exp" placeholder="">
