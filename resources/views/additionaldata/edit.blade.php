        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Edit Additional Data Data Employee</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    @endif --}}
                <form class="form-horizontal" action="/updateAdditionaldata/{{$additionaldatas->slug}}" method="post">
                    @method('put')
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="col-sm-3">
                                <select name="employee_id" class="form-control select2 select2-hidden-accessible">
                                    ...
                                    <option value="{{ $employee->id }}"
                                      {{ old('employee_id', $additionaldatas->employee_id) == $employee->id ? 'selected' : '' }}>
                                      {{ $employee->fullname }}
                                    </option>
                                    @endforeach
                                  </select>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-3">
                            <input type="text" value="{{$additionaldatas->cloth_size}}" name="cloth_size" class="form-control" id="cloth_size" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{$additionaldatas->pants_size}}" name="pants_size" class="form-control" id="pants_size" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{$additionaldatas->shoes_size}}" name="shoes_size" class="form-control" id="shoes_size" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{$additionaldatas->height}}" name="height" class="form-control" id="height" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{$additionaldatas->weight}}" name="weight" class="form-control" id="weight" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{$additionaldatas->glasses}}" name="glasses" class="form-control" id="glasses" placeholder="">
