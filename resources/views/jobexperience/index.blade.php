        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Job Experiences Employee Data Table</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="col-sm-12 col-md-6">
                    <div class="mt-5 d-flex justify-content-end">
                      <a href="{{route('addJobexperiences')}}" class="btn btn-primary btn-sm">Add Data</a>
                  </div>
                  </div>
                </div>
                <div class="mt-5">
                ...
                <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Job Position</th>              
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Job Duration</th>              
                  <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Quit Reason</th>              
                ...
                <tbody>
                  @foreach ($jobexperiences as $item)
                    <tr class="odd">
                      ...
                      <td>{{ $item->fullname }}</td>
                      <td class="sorting_1">{{ $item->company_name }}</td>
                      <td class="sorting_1">{{ $item->job_position }}</td>
                      <td class="sorting_1">{{ $item->job_duration }}</td>
                      <td class="sorting_1">{{ $item->quit_reason }}</td>
                      <td class="text-center">
                        <form action="deleteJobexperiences/{{$item->slug}}" method="post"
                          ...
                          <a href="editJobexperiences/{{$item->slug}}" class="btn btn-primary btn-sm">
