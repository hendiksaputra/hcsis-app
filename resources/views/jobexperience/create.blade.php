        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Add Job Experiences Data Employee</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    @endif --}}
                <form class="form-horizontal" action="{{route('addJobexperiences') }}" method="post">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-3">
                            <input type="text" value="{{ old('company_name') }}" name="company_name" class="form-control" id="company_name" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{ old('job_position') }}" name="job_position" class="form-control" id="job_position" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{ old('job_duration') }}" name="job_duration" class="form-control" id="job_duration" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{ old('quit_reason') }}" name="quit_reason" class="form-control" id="quit_reason" placeholder="">
