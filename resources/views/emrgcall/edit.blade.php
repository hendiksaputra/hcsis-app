        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Edit Emergency Call Data Employee</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    @endif --}}
                <form class="form-horizontal" action="/updateEmrgcall/{{$emrgcalls->slug}}" method="post">
                    @method('put')
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="col-sm-3">
                                <select name="employee_id" class="form-control select2 select2-hidden-accessible">
                                    ...
                                    <option value="{{ $employee->id }}"
                                      {{ old('employee_id', $emrgcalls->employee_id) == $employee->id ? 'selected' : '' }}>
                                      {{ $employee->fullname }}
                                    </option>
                                    @endforeach
                                  </select>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-3">
                            <input type="text" value="{{$emrgcalls->emrg_call_name}}" name="emrg_call_name" class="form-control" id="emrg_call_name" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{$emrgcalls->emrg_call_relation}}" name="emrg_call_relation" class="form-control" id="emrg_call_relation" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{$emrgcalls->emrg_call_phone}}" name="emrg_call_phone" class="form-control" id="emrg_call_phone" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{$emrgcalls->emrg_call_address}}" name="emrg_call_address" class="form-control" id="emrg_call_address" placeholder="">
