        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Edit Family Data Employee</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    @endif --}}
                <form class="form-horizontal" action="/updateFamilie/{{$families->slug}}" method="post">
                    @method('put')
                    @csrf
                    <div class="card-body">
                            ...
                            <div class="col-sm-3">
                                <select name="employee_id" class="form-control select2 select2-hidden-accessible">
                                    ...
                                    <option value="{{ $employee->id }}"
                                      {{ old('employee_id', $families->employee_id) == $employee->id ? 'selected' : '' }}>
                                      {{ $employee->fullname }}
                                    </option>
                                    @endforeach
                                  </select>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-3">
                            <input type="text" value="{{$families->family_name}}" name="family_name" class="form-control" id="family_name" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{$families->family_relationship}}" name="family_relationship" class="form-control" id="family_relationship" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{$families->family_birthplace}}" name="family_birthplace" class="form-control" id="family_birthplace" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="date" value="{{$families->family_birthdate}}" name="family_birthdate" class="form-control" id="family_birthdate" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{$families->family_remarks}}" name="family_remarks" class="form-control" id="family_remarks" placeholder="">
