        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Add Insurance Data Employee</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
                ...
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    @endif --}}
                <form class="form-horizontal" action="{{route('addInsurance') }}" method="post">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-3">
                            <input type="text" value="{{ old('health_insurance_type') }}" name="health_insurance_type" class="form-control" id="health_insurance_type" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{ old('health_insurance_no') }}" name="health_insurance_no" class="form-control" id="health_insurance_no" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{ old('health_facility') }}" name="health_facility" class="form-control" id="health_facility" placeholder="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                              <input type="text" value="{{ old('health_insurance_remarks') }}" name="health_insurance_remarks" class="form-control" id="health_insurance_remarks" placeholder="">
