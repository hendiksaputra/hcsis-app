                  ...
                  <div class="col-sm-12 col-md-6">
                    ...
                    <form class="row g-3" method="post" action="{{route('addEmployee') }}" enctype="multipart/form-data">
                        ...
                        <div class="col-3">
                          ...
                          <div class="col-md-3">
                            <label for="image" class="form-label">Document (Photo,KTP,KK,SIM..dll)</label>
                            <input type="file" value="{{ old('image') }}" class="form-control" id="image" name="image" placeholder="Choose an image">
                          </div>
                          {{-- <div class="col-md-3">
